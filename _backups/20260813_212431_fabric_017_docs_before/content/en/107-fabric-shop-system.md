...
In 0.1.6, the Item ID row opens a searchable item picker. Manual entry and inventory selection remain available, while the picker searches localized item names, namespaces, and full registry IDs with page-scoped icon previews.
