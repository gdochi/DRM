...
Dochi's Warfare 0.2.4 routes supported guns through one managed combat controller. DW owns target selection, stance, tactical movement, accuracy policy, firing opportunities, reload timing, reserve `Ammo Stock`, animation signals, and persistence.
