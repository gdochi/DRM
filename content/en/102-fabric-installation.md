...
`fabric.mod.json` declares CustomNPCs, Mod Menu, FTB Quests, and CobbleDollars as suggested integrations.
...
DRM can boot without CustomNPCs, and its file, GUI, and HUD authoring surfaces remain available. CustomNPCs is still required for the NPC-specific workflows.
