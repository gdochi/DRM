...
slug: installation
order: 30
description: Requirements and client/server roles for DRM Core 0.1.9 on Fabric 1.21.1.
product: core-fabric
...
| --- | --- | --- |
| DRM Core | `0.1.9` Fabric build | `dochi_rpg_maker-0.1.9-fabric-1.21.1.jar` |
...
1. Put the same DRM Core 0.1.9 Fabric JAR in the client and server `mods` folders.
